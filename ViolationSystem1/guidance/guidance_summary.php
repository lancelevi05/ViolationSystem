...
<body style="">
  ...
  border-radius: 50%; transition: opacity 0.4s ease;" id="profilePic" alt="Profile" />
      ...
      <div class="sidebar-content">
        ...
        <ul class="menu-list">
          ...
          <li class="menu-item">
            <a href="guidance_summary.php" class="menu-link active">
  ...
  scrollbar-width: thin;">
      ...
      <h3>College Senior High Distribution</h3>
      <canvas id="statusChart" style="width:1000px;height:400px;background-color:var(--color-bg-form)"></canvas>
  ...
  <script>
    ...
    let myChart = new Chart(ctx, {
      ...
      options: {
        ...
        maintainAspectRatio: true, // not-allow custom height/width
    ...
    async function fetchData(filter, value) {
      ...
      const response = await fetch(`guidance_summary.php?fetchData=1&${query}`);
...
<style>
  ...
  height: 400px;     /* desired desktop height */
