...
college_tbl.id,
    ...
    college_tbl.fname, 
    college_tbl.mname, 
    college_tbl.idstrandcourse,
    college_tbl.section,
    strandcourse_tbl.strandcourse, 
    gender_tbl.gender,
    college_tbl.birthdate, 
    college_tbl.address, 
    college_tbl.glevel, 
    college_tbl.vio_record,
    collegedep_tbl.department
FROM college_tbl
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($idstrandcourse == 7 || $idstrandcourse == 8 || $idstrandcourse == 11 || $idstrandcourse == 12) {
    $department = 1;
  } elseif ($idstrandcourse == 10 || $idstrandcourse == 14 || $idstrandcourse == 9) {
    $department = 2;
  } elseif ($idstrandcourse == 13) {
...
<body style="">
  ...
  ">
      ...
      <br>
      <a href="admin_addstudent2.php"> <button class="add-btn">
          <p class="btn-addlabel"><b>Add Student</b></p>
        </button></a>
    ...
    white-space: nowrap; /* prevent wrapping */">
        <table id="collegeTable" class="display" style=" ">
      ...
      <section class="report-section" id="formContainer" style="display:none;">
        <div class="report-container">
          ...
          <div class="report-form">
            <h2 class="report-title">EDIT College Student Form</h2>

            <form action="admin_college.php" method="POST" enctype="multipart/form-data">
 ...
 <!-- totalvio -->
              ...
              <div class="form-action">
                ...
                <button type="button" class="submit-btn" style="background-color:#D8F8F6; color:black"
  ...
  <div id="deleteModal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%;
    ...
    <script>
      ...
      document.getElementById("confirmDelete").onclick = function () {
        ...
        fetch("college_delete.php?id=" + deleteId)
          .then(() => {
    ...
    window.location.reload();
      ...
      $(document).ready(function () {
        $('#collegeTable').DataTable({
          ...
          "order": [[0, "asc"]],  // Default sort by First Name
          "columnDefs": [
      ...
      document.querySelectorAll('.editBtn').forEach(button => {
        button.addEventListener('click', async function () {
          ...
          const res = await fetch('fetch_student2.php?id=' + studentId);
