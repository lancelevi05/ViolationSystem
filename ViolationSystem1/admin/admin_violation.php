                ...
                margin-left: 5px;">
                    ...
                    <li class="menu-item has-dropdown">
                        ...
                        <ul class="submenu">
                            ...
                            <li class="menu-link"><a href="admin_college.php"
                                    style="color:var(--color-text-primary)">College</a></li>
                            <li class="menu-link"><a href="user_management.php"
                                    style="color:var(--color-text-primary)">User Logs</a>
                            </li>
                        </ul>
            ...
            <div class="reports-section">
                <div class="report-grid" id="reportGrid">
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <div class="report-card" data-status="<?= $row['status_id'] ?>"
                            ...
                            <div class="report-info">
                                ...
                                <p><strong>STRAND/COURSE:</strong>
                                    <?= $row['strandcourse'] . '-' . $row['glevel'] . $row['section'] ?></p>
                    ...
                    background-color:#7AEE0F; padding:5px 15px; border-radius:50px; cursor:pointer;">Resolve
                                        Case</button>
                                <?php else: ?>
