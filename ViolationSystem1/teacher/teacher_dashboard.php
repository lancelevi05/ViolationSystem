...
// --- Count total Pending and Dismissed for this teacher's advisory students ---
$statusQuery = "
    SELECT 
    ...
    LEFT JOIN violation v 
        ON vs.status_id = v.status_id
        AND EXISTS (
            SELECT 1 
            FROM advisory_tbl a 
            WHERE a.adviser_id = '$current_user_id'
              AND a.idstrandcourse = v.idstrandcourse
              AND a.glevel = v.glevel
              AND a.section = v.section
        )
...
// --- Count total violations for this teacher's advisory students ---
$totalQuery = "
...
// --- Count total number of students in this teacher's advisory ---
$studentQuery = "
    SELECT COUNT(*) AS total_students
    FROM shs_tbl s
    INNER JOIN advisory_tbl a
        ON a.idstrandcourse = s.idstrandcourse
        AND a.glevel = s.glevel
